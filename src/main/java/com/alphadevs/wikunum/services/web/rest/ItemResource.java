...
import com.alphadevs.wikunum.services.service.ItemQueryService;
import com.alphadevs.wikunum.services.service.ItemService;
...
/**
 * REST controller for managing {@link com.alphadevs.wikunum.services.domain.Item}.
 */
@RestController
@RequestMapping("/api")
public class ItemResource {
    ...
    private static final String ENTITY_NAME = "inventoryManagementItem";
     ...
     */
    @GetMapping("/items")
    public ResponseEntity<List<Item>> getAllItems(ItemCriteria criteria, @org.springdoc.api.annotations.ParameterObject Pageable pageable) {
