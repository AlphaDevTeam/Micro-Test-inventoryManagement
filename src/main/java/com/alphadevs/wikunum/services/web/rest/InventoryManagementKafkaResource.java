...
@RestController
@RequestMapping("/api/inventory-management-kafka")
public class InventoryManagementKafkaResource {

    private final Logger log = LoggerFactory.getLogger(InventoryManagementKafkaResource.class);
    ...
    public InventoryManagementKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
