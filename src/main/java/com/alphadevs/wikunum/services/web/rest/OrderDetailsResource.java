...
import com.alphadevs.wikunum.services.service.OrderDetailsQueryService;
...
/**
 * REST controller for managing {@link com.alphadevs.wikunum.services.domain.OrderDetails}.
 */
@RestController
@RequestMapping("/api")
public class OrderDetailsResource {
    ...
    private static final String ENTITY_NAME = "inventoryManagementOrderDetails";
